        ...
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            <iframe
              ...
              marginWidth={0}
              scrolling="no"
              src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d174.69393514452!2d67.15058059714272!3d24.86505473830861!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sen!2s!4v1722158349565!5m2!1sen!2s"
            />
            <div className="bg-black relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className="mt-1 text-gray-400">
                  Saima Luxury Homes, Bagh-e-Korangi near malir river bridge, Karachi
                </p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a className="leading-relaxed text-gray-400">muhammadahmedqamar07@gmail.com</a>
                <h2 className="title-font font-semibold text-gray-100 tracking-widest text-xs mt-4">
                  PHONE
                </h2>
                <p className="leading-relaxed text-gray-400">+92 349-7009214</p>
              </div>
            </div>
          </div>
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <button className="text-white bg-black border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 hover:text-black rounded text-lg">
              Submit
            </button>
          </div>
        </div>
